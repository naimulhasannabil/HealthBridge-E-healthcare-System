        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-400">
              Connecting Patients and Doctors Digitally
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-400 hover:text-white transition">Virtual Consultations</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition">Appointment Scheduling</a></li>
          ...
          <div>
            ...
            <address className="text-gray-400 not-italic">
              ...
              <p className="mt-2">Email: info@healthbridge.com</p>
